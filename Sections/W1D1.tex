...
\begin{theorem}[{\cite[Theorem 1.B.7-9]{hatcher_algebraic_2001}}]
...
For \(n\geq 2\), any map \((\mb{S}^n , \star) \to (X,x_0)\) lifts to \((\mb{S}^n , \star) \to (\tilde X, \tilde x_0)\) (Since \(pi_1(\mb{S}^n ,\star)\) is trivial). If \(X\) is aspherical, then \((\mb{S}^n , \star) \to (\tilde X, \tilde x_0)\) is null-homotopy. Hence \(\pi_n(X,x_0) =0\).                   

\begin{theorem}[{\cite[Theorem 4.5]{hatcher_algebraic_2001}}]
