...
The free resolution arises naturally from \(K(G,1)\) in the following manner. Say \(X\) is a CW complex \(K(G,1)\) (recall \cref{def:KG1}), then its cellular \(i\)-chain \(C_i(\tilde X; \Z)\) is a free \(\Z G\)-module with basis in bijective with \(i\)-celss in \(X\). (Recall that \(G\) acts freely on \(\tilde X\), so \(G\) acts on \(C_i(\tilde X ; \Z)\) freely.)
...
\begin{definition}
    ...
    Let \(M\) be a left \(\Z G\)-module. Let \(F = \{(F_i, d_i)\}\) be a free resolution of \(\Z\). We truncate \(F\) at \(n\) to get a  finite (non-exact) complex:
   
     \[ 
        F_i \xrightarrow{d_i} F_{i-1} \xrightarrow{d_{i-1}}\cdots \xrightarrow{d_1} F_0 \to 0 .
    \]

    Apply \(\Hom{\_}{M}{\Z G}\) to the complex. Denote \(F^i = F_i^* =  \Hom{F_i }{M }{\Z G}\). We have:
    \[ 
        F^i \xleftarrow{d^{i-1}} F^{i-1} \xleftarrow{d^{i-2}}\cdots \xleftarrow{d^0} F^0 \xleftarrow{} 0 .
    \]
...
\[
    \Hom{F_1 }{M }{\Z G} \xleftarrow{d^0 =d_1^*} \Hom{F_0}{M }{\Z G} \xleftarrow{\epsilon^*} \Hom{\Z }{M }{\Z G} \xleftarrow 0.
\]
