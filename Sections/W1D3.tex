...
\begin{example}[Compactly supported cohomology of \(\mathbb{F}_2\)]
...
The example above shows that \(1\)-cohomology of the group with group-ring coefficients has rank of numbers of ends of the group plus 1.